...
NAMES = {
    "폰": "폰", "공유기": "공유기", "컴퓨터": "내 컴퓨터", "서버": "서버",
    "겹친서버": "서버 여럿", "사람": "사람", "구름": "인터넷", "저장통": "저장소",
    "자물쇠": "잠금", "열쇠": "열쇠", "문서": "문서", "벽": "막는 벽", "문": "문",
    "지구": "전 세계", "시계": "시간", "돋보기": "찾기", "표지판": "안내",
    "장부": "이름 장부", "소포": "짐", "고리": "이어짐", "사물함": "칸칸이",
    "계단": "단계", "갈래": "갈림길", "스위치": "스위치", "막대": "양",
    "깔때기": "거르기", "동전": "값", "그래프": "추이",
}
