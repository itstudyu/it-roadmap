...
NAMES = {
    # 부품은 **그것이 IT 에서 무엇을 뜻하는지가 아니라, 현실에서 무엇처럼
    # 생겼는지**로 부른다. 열 살이 아는 낱말만 쓴다.
    #
    # 처음에는 서버를 "서버" 라고 불렀는데, 그 낱말은 이 단어장이 열 살
    # 카드에서 금지한 36개 중 하나다. 그림이 금지어로 설명하면 그림을 보고
    # 남에게 옮길 수가 없다. 그림의 일은 열 살에게 손에 잡히는 세계를 주는
    # 것이고, 그것이 IT 에서 무엇에 해당하는지는 본문이 할 말이다.
    "사람": "사람", "폰": "폰", "컴퓨터": "내 기계",
    "서버": "저쪽 기계", "겹친서버": "기계 여럿",
    "공유기": "와이파이 상자", "구름": "인터넷", "지구": "온 세상",
    "저장통": "보관함", "사물함": "칸칸이", "장부": "이름 공책",
    "문서": "종이", "소포": "택배", "동전": "돈",
    "자물쇠": "자물쇠", "열쇠": "열쇠", "문": "문", "벽": "벽",
    "시계": "시계", "돋보기": "돋보기", "표지판": "이정표",
    "계단": "계단", "갈래": "갈림길", "고리": "고리",
    "스위치": "스위치", "깔때기": "체", "막대": "얼마나", "그래프": "오르내림",
}
