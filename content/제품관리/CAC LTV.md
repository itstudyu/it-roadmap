...
### 이름
Customer Acquisition Cost :: 한 명 데려온 값
Lifetime Value :: 평생 남기는 값
= 앞은 나가는 돈, 뒤는 들어오는 돈. 나란히 놓아야 비로소 뜻이 생기는 짝이다

### 비유
전단지 값과 그 손님이 평생 사 갈 금액. 전단지에 든 돈이 더 크면 손님이 늘어날수록 손해다.

### 예
가입만 하면 만 원 쿠폰을 주는 서비스가 있다. 그 만 원보다 내가 평생 쓸 돈이 커야 남는 장사다.
...
**"한 명 데려오는 값과 그 한 명이 남기는 값"** 이라고 읽으면 된다. 둘의 비율이 마케팅을 더 써도 되는지를 정하고, 회수 기간이 그 사이 버틸 현금을 정한다. 가입자 수만 보면 늘수록 손해인 구조를 알아채지 못한다.

## 🧒 열 살에게

손님을 부르려고 전단지를 돌린다고 해 봐. 전단지 만드는 데 든 돈보다 그 손님이 두고두고 사 갈 돈이 더 커야 남는 거야. 아니면 손님이 늘어날수록 오히려 손해가 커져.

## ❓ 이해했는지

- 신규 가입자가 매달 늘고 있는데 이익은 줄고 있다. 무엇을 계산해 봐야 하나 → 해결하는 문제
- LTV 와 CAC 가 똑같은 두 회사가 있는데 한 곳만 현금이 마른다. 무엇이 다른가 → 흔한 오해
- 월 이탈률을 5% 에서 3% 로 낮추면 LTV 는 왜 움직이나 → 작동 원리

## 🔗 관련 용어

- [[North Star Metric]] — 이 숫자들 위에 놓는 하나의 대표 지표
