...
### 이름
= 프랑스어 cacher(감추다)에서 온 말. 나중에 쓰려고 감춰 둔 곳간을 가리키던 말이 그대로 왔다
...
### 직접
사진이 많은 페이지를 열고 곧바로 새로고침해 보라. 두 번째가 눈에 띄게 빠른 건 이미 받아 둔 것을 꺼내기 때문이다.
...
**"멀리 안 가려고 가까이 놔둔 그 사본"** 이라고 읽으면 된다. 느린 곳을 빠르게 만드는 게 아니라 느린 곳에 덜 가게 만드는 방법이고, 어려운 부분은 넣는 게 아니라 언제 버릴지 정하는 쪽이다.

## 🧒 열 살에게

자주 보는 책은 서가까지 걸어가지 않고 책상 위에 꺼내 두지? 그러면 볼 때마다 오가던 시간이 통째로 없어져. 대신 책상이 좁아서 안 보는 건 도로 꽂아야 하고, 서가의 책이 새 판으로 바뀌어도 책상 위 건 옛날 판 그대로야.
