...
AI :: 사람처럼 판단하는 것
Agent :: 대신 일하는 사람
= 붙여 읽으면 "스스로 판단해 대신 일하는 사람". 답을 아는 쪽이 아니라 다녀오는 쪽이다

### 비유
심부름을 맡긴 사람. 백과사전은 물어본 것만 답하지만, 심부름꾼은 가게에 다녀오고 문이 닫혀 있으면 다른 가게를 찾는다.

### 예
여행 일정을 짜 달라고 맡겼더니 검색과 지도를 스스로 오가며 몇 번을 고쳐 일정표 한 장을 내놓는다.

### 직접
챗봇에게 "지금 서울 날씨" 를 물어보라. 검색을 다녀와 답하면 도구를 쥔 것이고, 모른다고 하면 못 쥔 것이다.
...
**"목표만 주면 알아서 다녀오는 그 심부름꾼"** 이라고 읽으면 된다. 모델이 달라져서가 아니라 도구와 반복이 바깥에 붙어 있어서 일을 끝까지 밀고 간다. 쓸 도구와 멈출 지점을 정하는 것은 사람의 몫으로 남는다.

## 🧒 열 살에게

두부 사 오라고 심부름을 시키면 어느 가게로 갈지, 문이 닫혔으면 어디로 갈지 네가 알아서 정하지? 이것도 똑같아. 무엇을 해 달라고만 말하면 스스로 여기저기 다녀오고, 헛걸음하면 다른 데로 가서 기어이 해 놓고 와.
