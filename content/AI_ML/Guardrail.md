...
Guard :: 지켜 막다
Rail :: 길가에 세운 난간
= 붙여 읽으면 "지켜 주는 난간". 운전을 대신해 주는 게 아니라 길 밖으로 나가는 것만 막는다
...
**"길 밖으로 나가는 것만 막아 세운 그 난간"** 이라고 읽으면 된다. 입력, 행동, 출력, 실행 네 자리에서 보는 것이 각각 다르다. 막는 일과 왜 막혔는지 알리는 일이 함께 가야 한다.

## 🧒 열 살에게

산길 옆에 쇠막대가 쭉 세워져 있는 거 봤지? 그게 차를 대신 몰아 주지는 않지만, 잘못 꺾어도 낭떠러지 쪽으로는 못 가게 딱 막아 줘. 여기서도 하면 안 되는 말이 들어오거나 나가려고 하면 그 자리에서 붙잡아.
