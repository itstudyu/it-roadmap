...
### 이름
= Certificate 는 라틴어 certus(확실한) + facere(만들다) — "확실하게 만든 것". 내가 아니라 남이 도장을 찍어 줘야 확실해진다

### 비유
신분증. 이름은 본인이 말하는 것이지만, 그 이름이 맞다는 것은 발급 기관이 보증한다.

### 예
오래된 사이트에 들어갔더니 경고 화면이 먼저 뜨고 그래도 계속하겠냐고 묻는 때가 있다. 인증서 검사에서 걸린 것이다.

### 직접
주소창의 자물쇠를 눌러 보라. 이 사이트의 인증서를 누가 서명했고 언제까지 쓸 수 있는지가 그 안에 적혀 있다.
...
**"주인이 맞다고 남이 보증해 준 그 종이"** 라고 읽으면 된다. 브라우저는 그 서명을 루트까지 거슬러 확인한 뒤에야 자물쇠를 띄우고 암호화를 시작한다. 신원을 증명할 뿐 그 사이트가 정직하다는 뜻은 아니다.

## 🧒 열 살에게

가게에서 네 이름을 말로만 하면 아무도 안 믿어 주지? 그런데 나라에서 만들어 준 신분증을 꺼내 보이면 그때는 믿어 줘. 인터넷 가게도 똑같이 자기 신분증을 먼저 내밀고, 기한이 지난 걸 내밀면 화면에 빨간 경고가 뜨는 거야.

## ❓ 이해했는지

- 인증서를 새로 설치했는데 어떤 브라우저에서만 경고가 뜬다. 무엇이 빠졌나 → 작동 원리
- 자물쇠가 떠 있는 사이트인데도 피싱일 수 있는 이유는 → 흔한 오해
- 금요일에 아무 배포도 안 했는데 월요일에 사이트가 막혔다. 무엇부터 확인하나 → 주의사항
