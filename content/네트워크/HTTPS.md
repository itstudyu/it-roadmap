...
HTTP :: 웹에서 쓰는 양식
Secure :: 안전한
= 붙여 읽으면 "안전해진 그 양식". 양식은 그대로 두고 겉을 한 겹 쌌다
...
### 직접
주소창의 자물쇠를 눌러 보라. 지금 이 연결이 어떤 증명서로 잠겨 있는지 그 자리에서 볼 수 있다.
...
**"내용을 가리고 상대까지 확인하는 그 연결"** 이라고 읽으면 된다. 내용을 가리는 일과 상대가 맞는지 확인하는 일을 같이 하며, 둘 중 하나만으로는 의미가 없다.

## 🧒 열 살에게

엽서는 배달하는 사람이 다 읽을 수 있지만, 봉투에 넣고 붙이면 받는 사람만 열어 봐. 인터넷에도 편지를 봉투에 넣어 보내는 방법이 있어. 봉투에 찍힌 도장으로 보낸 곳이 진짜인지도 알 수 있어.
